...
import com.bftv.fui.net.adapter.CacheCall;
import com.bftv.fui.net.adapter.Call;
import com.bftv.fui.net.adapter.CallAdapter;
import com.bftv.fui.net.adapter.DefaultCallAdapter;
...
import com.bftv.fui.net.convert.Converter;
...
public abstract class BaseRequest<R extends BaseRequest> {
    ...
    public com.bftv.fui.net.okhttp.okhttp3.Call generateCall(Request request) {
        mRequest = request;
    ...
    /** 获取同步call对象 */
    public com.bftv.fui.net.okhttp.okhttp3.Call getCall() {
        //构建请求体，返回call对象
